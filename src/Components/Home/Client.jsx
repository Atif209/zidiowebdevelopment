...
const Client = () => {
    ...
    const clientData = [
        {
            text: "Zidio went above and beyond our expectations. Their team was professional, responsive, and provided a high-quality solution that perfectly met our needs. We are extremely pleased with the results.",
